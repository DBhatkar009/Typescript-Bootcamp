...
let uniqueIdData = "jvb46546464566bf4gb4fb466";
uniqueIdData = 56000;
let uniqueSymbol = 10000;
console.log("uniqueSymbol:", uniqueSymbol);
const newData = [5000, 500, 478, "this is a string", "this is another string"];
...
const thisIsMe = null; // Union type with null
if (thisIsMe === null) {
...
const userAge = null; // Uinon type with using --strictNullChecks
console.log(userAge);
let createUser;
